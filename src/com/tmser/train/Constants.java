...
public class Constants {
	...
	"<p style=\"text-align:left;\">欢迎使用<span style=\"\" color:=\"E53333\"><strong>购票助手</strong></span></p>"+
	"<p style=\"text-align:left;\">当前版本：正式版 v1.0&nbsp;&nbsp;&nbsp;发布日期：2013.10.31</strong></p>"+
	"<p style=\"text-align:left;\">该版本为以开源GO HOME为基础制作，仅限个人使用！</p>"+
	"<p style=\"text-align:left;\">有需要源码的请email到下面邮箱。</p>"+
	"<p style=\"text-align:right;\"><strong><em><span style=\"color:#E53333;\">祝您使用愉快！</span></em></strong></p>"+
	"<p style=\"text-align:left;\">作者：<em><a> Tmser </a></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email：<em>tmser@tmser.com</em>"+
	"<p style=\"text-align:left;\">Copyright (C) 2013 By Tmser.</p>";
	 ...
	 * 验证码验证
	 */
	public static String  CHECK_RAND  = Config.getProperty("check_code_url");
	 ...
	 * 订单提交验证码
	 */
	public static String ORDER_CODE_URL = Config.getProperty("order_code_url");
  	public static String SUBMIT_WAIT_URL= Config.getProperty("submit_wait_url");
  
  	public static String GET_COUNT_URL = Config.getProperty("get_count_url");
  	
  	public static String QUERY_LOG_URL= Config.getProperty("query_log_url");
	public static String QUERY_ORDER_URL = Config.getProperty("query_order_url");
	//										https://dynamic.12306.cn/otsweb/order/querySingleAction.do?method=queryLeftTicket
	
	/**
	 * 查询车次信息
	 */
	public static String QUERY_TRAIN_URL = Config.getProperty("query_train_url");
	
	/**
	 * 检查用户是否登录
	 */
	public static String CHECK_LOGIN_URL = Config.getProperty("check_login_url");
	
	/**
	 * 订单确认预定页，获取token
	 */
	public static String TOKEN_URL = Config.getProperty("token_url");	
	
	public static String QUERY_ORDER_QUEE = Config.getProperty("query_order_quee");
	
	public static String SUBMIT_URL =Config.getProperty("submit_url");
	
	/**
	 * 检查订单
	 */
	public static String CHECK_ORDER_URL = Config.getProperty("check_order_url");
	
	public static String LOGIN_OUT_URL = Config.getProperty("loginout_url");
	
	/**
	 * 联系人加载
	 */
	public static String TOP_CONTACTS_URL = Config.getProperty("contacts_url");
	...
	public static String TRAIN_L = "L";
	 ...
	 * 锁定车次
	 */
	public static byte isLockTrain = 0;
	/**
	 * 精确匹配
	 */
	public static byte isStrinStation = 1; 
	/**
	 * 特等座
	 */
	public static byte isNeed_BEST_SEAT = 2;// 特等座(余票)
	/**
	 * 商务座
	 */
	public static byte isNeed_BUSS_SEAT = 3; // 商务座
	/**
	 * 硬座
	 */
	public static byte isNeed_HARD_SEAT = 4;// 硬座(余票)
	/**
	 * 硬卧
	 */
	public static byte isNeed_HARD_SLEEPER = 5;// 硬卧(余票)
	/**
	 * 无座
	 */
	public static byte isNeed_NONE_SEAT = 6; // 无座
	/**
	 * 一等座
	 */
	public static byte isNeed_ONE_SEAT = 7;// 一等座(余票)
	/**
	 * 高级软卧
	 */
	public static byte isNeed_VAG_SLEEPER = 8;// 高级软卧(余票)
	/**
	 * 软座
	 */
	public static byte isNeed_SOFT_SEAT = 9;// 软座(余票)
	/**
	 * 软卧
	 */
	public static byte isNeed_SOFT_SLEEPER = 10;// 软卧(余票)
	/**
	 * 二等座
	 */
	...
	public final static String CODE_ERROR="请输入正确的验证码";
	public final static String USER_SUCC_INFO="欢迎您登录中国铁路客户服务中心网站";
	public final static String LOGIN_ERR_INFO="<title>登录</title>";
	public final static String LOGIN_LOSTS_POEPLE="当前访问用户过多";
	public final static String UNKNOW_ERROR="未知错误";
	
	public final static String USER_RELOGIN="当前访问用户过多,请重新登录";
	public final static String USER_ERR="帐号或密码错误";
	public final static String LOGIN_SUC="登录成功";
	public final static String CHENPIAO_YUDING="车票预订";
	...
	public static Map<String, String>  trainRang = new TreeMap<String, String>();
	public static Map<String, String>  rangTrain = new TreeMap<String, String>();
	public static Map<String, String> cardType = new TreeMap<String, String>();
	public static Map<String, String> typeCard = new TreeMap<String, String>();
	
	public static Map<String, String> ticketType = new TreeMap<String, String>();
	public static Map<String, String> typeTicket = new TreeMap<String, String>();
	static {		
		trainPriorityMap.put(TRAIN_L, 40);
		...
		rangTrain.put("00:00--24:00","全天");
		rangTrain.put("06:00--12:00","上午");
		rangTrain.put( "12:00--18:00","下午");
		rangTrain.put("18:00--24:00","晚上");
		rangTrain.put("00:00--06:00","凌晨");
		
		cardType.put("二代身份证", "1");
		cardType.put("一代身份证", "2");
		cardType.put("港澳通行证", "C");
		cardType.put("台湾通行证", "G");
		cardType.put("护照", "B");
		...
		ticketType.put("成人票", "1");
		ticketType.put("儿童票", "2");
		ticketType.put("学生票", "3");
		ticketType.put("残军票", "4");
		
		typeTicket.put("1","成人票");
		typeTicket.put("2","儿童票");
		typeTicket.put("3","学生票");
		typeTicket.put("4","残军票");
		
	}
	
	public static String[] getRangTime() {
		return new String[]{"全天","上午","下午","晚上","凌晨"};
	}
	
	public static String[] getCardType() {
		return new String[]{"二代身份证","一代身份证","港澳通行证","台湾通行证","护照",};
	}
	
	public static String[] getTicketType() {
		return new String[]{"成人票","儿童票","学生票","残军票"};
	}
	/**
	 * @return Returns the trainSeatMap.
	 */
