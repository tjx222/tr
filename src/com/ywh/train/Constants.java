...
public class Constants {
	...
	"<p style=\"text-align:left;\">欢迎使用<span style=\"\" color:=\"E53333\"><strong>我要回家</strong></span></p>"+
	"<p style=\"text-align:left;\">当前版本：改进版 v2.0&nbsp;&nbsp;&nbsp;发布日期：2013.01.31</strong></p>"+
	"<p style=\"text-align:left;\">该版本荣誉归属与广大热心的网友以及为此项目做出贡献的人！</p>"+
	"<p style=\"text-align:left;\">该项目开源地址为：http://code.google.com/p/go-home/</p>"+
	"<p style=\"text-align:right;\"><strong><em><span style=\"color:#E53333;\">祝您使用愉快！</span></em></strong></p>"+
	"<p style=\"text-align:left;\">作者：<em><a> Tmser </a></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email：<em>talentyao@foxmail.com</em>"+
	...
	//									   https://dynamic.12306.cn/otsweb/passCodeAction.do?rand=sjrand&0.04645713394336548
...
//string randStr = CommUitl.getString(uri,CommData.cookieContainer);
	...
	//public static String ORDER_CODE_URL = "https://dynamic.12306.cn/otsweb/passCodeAction.do?rand=sjrand";
   ...
   //action="/otsweb/order/confirmPassengerAction.do?method=confirmPassengerInfoSingle"
  	// 排队拿号							   https://dynamic.12306.cn/otsweb/order/myOrderAction.do?method=queryOrderWaitTime&tourFlag=dc
	...
	//								   https://dynamic.12306.cn/otsweb/order/confirmPassengerAction.do?method=payOrder&orderSequence_no=E795272056
